...
another3_large_airportIcon_airportIcon.bindPopup('Port Moresby Jacksons International Airport');

var another1_airportIcon = L.marker([45.32249832	-75.66919708], {icon: large_airportIcon}).addTo(map);
another1_airportIcon.bindPopup('Ottawa Macdonald-Cartier International Airport');
